...
module.exports = {
    ...
    requiredroles: ["rol id si gir"], //Only allow specific Users with a Role to execute a Command [OPTIONAL]
    ...
    run: async (client, interaction) => {
        ...
        try {
           ...
           // interaction.reply({ content: "Yükleniyor...", ephemeral: true });
            ...
            //LOG SİSTEMİ
            client.channels.cache.get('log kanalı id si gir').send(`${interaction.user.tag} tarafından ${isim} ${soyisim} kişisi sorgulandı.`)
